import { checkout, removeProductFromCart } from '@/actions';
import { ChceckoutButton, DeleteItem } from '@/components/submit-buttons';
            ...
            <div key={item.id} className='flex'>
              ...
              <div className='ml-5 flex justify-between w-full font-medium'>
                ...
                <div className='flex flex-col h-full justify-between'>
                  ...
                  <form action={removeProductFromCart} className='text-end'>
